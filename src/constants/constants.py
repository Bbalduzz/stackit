...
class Alignment(StrEnum):
    ...
    def from_string(cls, value: Union[str, "Alignment"]) -> "Alignment":
        ...
        raise ValueError(
            f"Invalid alignment: {value}. Valid options: {list(legacy_map.keys())}"
        )
...
class Orientation(StrEnum):
    ...
    def from_string(cls, value: Union[str, "Orientation"]) -> "Orientation":
        ...
        raise ValueError(
            f"Invalid orientation: {value}. Valid options: horizontal, vertical"
        )


class SymbolRenderingMode(StrEnum):
    """SFSymbol rendering mode options."""
    ...
    @classmethod
    def from_string(
        cls, value: Union[str, "SymbolRenderingMode"]
    ) -> "SymbolRenderingMode":
        if isinstance(value, cls):
            return value
        ...
        raise ValueError(
            f"Invalid rendering mode: {value}. Valid options: {[m.value for m in cls]}"
        )
...
class MapType(StrEnum):
    ...
    def to_mapkit_constant(self):
        ...
        # newer map types with fallbacks
...
class BadgeType(StrEnum):
    ...
    def from_string(cls, value: Union[str, "BadgeType"]) -> "BadgeType":
        ...
        if value_lower in ["updates", "update"]:
            ...
            raise ValueError(
                f"Invalid badge type: {value}. Valid options: updates, new-items, alerts"
            )
...
def convert_orientation(
    value: Union[str, Orientation], warn: bool = True
) -> Orientation:
...
def convert_rendering_mode(
    value: Union[str, SymbolRenderingMode], warn: bool = True
) -> SymbolRenderingMode:
...
def convert_symbol_scale(
    value: Union[str, SymbolScale], warn: bool = True
) -> SymbolScale:
...
def convert_symbol_weight(
    value: Union[str, SymbolWeight], warn: bool = True
) -> SymbolWeight:
